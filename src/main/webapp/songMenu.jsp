    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">购买歌单</h4>
            </div>
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <span style="font-size: 20px; font:bold">歌单：${songMenu.menuname}<br/></span>
    ...
    <div class="navWrap">
        <div class="nav">
            <ul class="homeNav">
                ...
                <li><a class="normal active" href="songmenu?songMenu1=songMenu1&id=1">歌单</a></li>
                </li>
            </ul>
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <table style="width: 200px;">
                <tr>
                    <img style="width: 200px;height: 200px;" src="${songMenu.cover}"
                         alt="..." class="img-thumbnail">
                </tr>
                <tr>
                    <td>
                        歌单名：${songMenu.menuname}
                    </td>
                </tr>
                <tr>
                    <td>
                        简介：${songMenu.description}
                    </td>
                </tr>
                <tr>
                    <td>
                        发行时间：${songMenu.createdate}
                    </td>
                </tr>
            </table>
        </div>
        <div class="col-md-6"><span style="font-size: 30px;">歌单列表</span>

            <select style="width:130px;" onchange="window.location=this.value" class="form-control">
                <c:forEach items="${songMenuList}" var="songMenuList">
                        <option value="songmenu?songMenu1=songMenu1&id=${songMenuList.id}">${songMenuList.menuname}</option>
                </c:forEach>
            </select>
